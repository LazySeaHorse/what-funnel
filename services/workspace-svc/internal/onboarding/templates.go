...
var Templates = map[string]BusinessTemplate{
	"salon": {
		...
		PipelineStates: []types.PipelineState{
			...
			{Key: "service_selected", Label: "Service Selected", Color: "#0057d0"},
			{Key: "date_requested", Label: "Date Requested", Color: "#c27aff"},
			{Key: "confirmed", Label: "Confirmed", Color: "#9ae600"},
	...
	"photography": {
		...
		PipelineStates: []types.PipelineState{
			...
			{Key: "package_sent", Label: "Package Sent", Color: "#0057d0"},
			{Key: "follow_up", Label: "Follow-up", Color: "#c27aff"},
			{Key: "booked", Label: "Booked", Color: "#9ae600"},
	...
	"tutoring": {
		...
		PipelineStates: []types.PipelineState{
			...
			{Key: "trial_scheduled", Label: "Trial Scheduled", Color: "#0057d0"},
			{Key: "trial_complete", Label: "Trial Complete", Color: "#c27aff"},
			{Key: "enrolled", Label: "Enrolled", Color: "#9ae600"},
	...
	"home_services": {
		...
		Label: "Home Services",
		PipelineStates: []types.PipelineState{
			{Key: "new_request", Label: "New Request", Color: "#64748b"},
			{Key: "quote_sent", Label: "Quote Sent", Color: "#0057d0"},
			{Key: "scheduled", Label: "Scheduled", Color: "#c27aff"},
			{Key: "completed", Label: "Completed", Color: "#9ae600"},
		},
		SummarySchema: map[string]string{
