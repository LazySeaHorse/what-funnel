...
<div class="col-span-12 lg:col-span-4 space-y-5">
  <div
    class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-2xs space-y-4"
  >
  ...
  <div
    class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-2xs space-y-3"
  >
  ...
  <div
    class="bg-red-50 border border-red-100 rounded-2xl p-5 shadow-2xs space-y-3"
  >
